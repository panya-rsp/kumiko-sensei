...
The generated status is the completion signal used by Kumiko Sensei. A handoff's `status: ready` only means it is ready to be processed; it does not mean that its visual was delivered.
